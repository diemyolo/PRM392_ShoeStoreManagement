...
public class TinyDB {
    ...
    public ArrayList<Shoe> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Shoe> playerList = new ArrayList<Shoe>();

        for (String jObjString : objStrings) {
            Shoe player = gson.fromJson(jObjString, Shoe.class);
    ...
    public void putListObject(String key, ArrayList<Shoe> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Shoe player : playerList) {
